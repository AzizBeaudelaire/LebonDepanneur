            ...
            <div>
              ...
              <div className="mt-8 space-y-6">
                <div className="flex items-center">
                  ...
                  <a 
                    href="tel:0770103429" 
                    className="ml-4 text-xl font-semibold text-light-primary transition-colors hover:text-light-hover dark:text-dark-primary dark:hover:text-dark-hover"
                  >
                    07 70 10 34 29
                  </a>
                </div>
                ...
                <div className="mt-6 flex items-center space-x-4">
                  <a
                    ...
                    className="flex items-center space-x-2 rounded-full bg-light-primary/10 p-2 transition-colors hover:bg-light-primary/20 dark:bg-dark-primary/10 dark:hover:bg-dark-primary/20"
                  >
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-300">@lebondepanneur</span>
                  </a>
                  <a
