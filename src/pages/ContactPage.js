...
import { contactFormSchema, sendContactEmail } from '../services/contact';
import { z } from 'zod';
            ...
            React.createElement("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" },
                React.createElement("div", { className: "grid gap-8 lg:grid-cols-2" },
                    React.createElement("div", { className: "order-1" },
                        React.createElement("div", { className: "rounded-lg bg-white p-6 shadow-lg transition-colors dark:bg-dark-card sm:p-8" },
                            ...
                            React.createElement("div", { className: "mt-8 space-y-6" },
                                React.createElement("div", { className: "flex items-center space-x-4" },
                                    ...
                                    React.createElement("div", null,
                                        ...
                                        React.createElement("a", { href: "tel:0770103429", className: "mt-1 block text-lg font-semibold text-light-primary transition-colors hover:text-light-hover dark:text-dark-primary dark:hover:text-dark-hover sm:text-xl" }, "07 70 10 34 29"))),
                                React.createElement("div", { className: "flex items-center space-x-4" },
                                    React.createElement("div", { className: "flex h-12 w-12 items-center justify-center rounded-full bg-light-primary/10 dark:bg-dark-primary/10" },
                                    ...
                                    React.createElement("div", null,
                                        ...
                                        React.createElement("a", { href: "mailto:hugo.mehdi197@gmail.com", className: "mt-1 block text-base text-gray-600 transition-colors hover:text-light-primary dark:text-gray-300 dark:hover:text-dark-primary sm:text-lg" }, "hugo.mehdi197@gmail.com"))),
                                React.createElement("div", { className: "flex items-center space-x-4" },
                                    React.createElement("div", { className: "flex h-12 w-12 items-center justify-center rounded-full bg-light-primary/10 dark:bg-dark-primary/10" },
                            ...
                            React.createElement("div", { className: "mt-8 flex flex-wrap gap-4" },
                                ...
                                React.createElement("a", { href: "https://wa.me/33770103429", target: "_blank", rel: "noopener noreferrer", className: "flex items-center space-x-2 rounded-lg bg-light-primary/10 px-4 py-2 transition-colors hover:bg-light-primary/20 dark:bg-dark-primary/10 dark:hover:bg-dark-primary/20" },
                    ...
                    React.createElement("div", { className: "order-2" },
                        React.createElement("form", { onSubmit: handleSubmit, className: "rounded-lg bg-white p-6 shadow-lg transition-colors dark:bg-dark-card sm:p-8" },
                            submitStatus === 'success' && (React.createElement("div", { className: "mb-6 rounded-md bg-green-50 p-4 dark:bg-green-900" },
                            ...
                            submitStatus === 'error' && (React.createElement("div", { className: "mb-6 rounded-md bg-red-50 p-4 dark:bg-red-900" },
                                React.createElement("p", { className: "text-red-800 dark:text-red-200" }, "Une erreur est survenue lors de l'envoi du message. Veuillez r\u00E9essayer."))),
                            React.createElement("div", { className: "space-y-6" },
                                ...
                                React.createElement("div", null,
                                    ...
                                    React.createElement("select", { name: "service", id: "service", value: formData.service, onChange: handleChange, className: `mt-2 block w-full rounded-lg border ${errors.service ? 'border-red-500' : 'border-light-border dark:border-dark-border'} bg-white px-4 py-3 text-light-text shadow-sm transition-colors focus:border-light-primary focus:outline-none focus:ring-light-primary dark:bg-dark-background dark:text-dark-text dark:focus:border-dark-primary dark:focus:ring-dark-primary`, required: true },
                                        ...
                                        React.createElement("option", { value: "transport" }, "Transport Europe"),
                                        React.createElement("option", { value: "assistance" }, "Assistance"),
                                        React.createElement("option", { value: "depannage" }, "D\u00E9pannage"),
                                        React.createElement("option", { value: "remorquage" }, "Remorquage"),
                                        React.createElement("option", { value: "levage" }, "Levage, Grutage, Treuillage"),
                                        React.createElement("option", { value: "fourriere" }, "Fourri\u00E8re"),
                                        React.createElement("option", { value: "atelier" }, "Atelier r\u00E9paration rapide"),
                                        React.createElement("option", { value: "clefs" }, "Perte de cl\u00E9fs"),
                                        React.createElement("option", { value: "nettoyage" }, "Nettoyage de v\u00E9hicule"),
                                        React.createElement("option", { value: "achat-revente" }, "Achat-Revente de v\u00E9hicules")),
                                ...
                                React.createElement("button", { type: "submit", disabled: isSubmitting, className: `w-full rounded-lg bg-light-primary px-6 py-4 text-base font-semibold text-white transition-colors hover:bg-light-hover focus:outline-none focus:ring-2 focus:ring-light-primary focus:ring-offset-2 dark:bg-dark-primary dark:hover:bg-dark-hover dark:focus:ring-dark-primary dark:focus:ring-offset-dark-background sm:text-lg ${isSubmitting ? 'cursor-not-allowed opacity-70' : ''}` }, isSubmitting ? 'Envoi en cours...' : 'Envoyer')))))))));
};
