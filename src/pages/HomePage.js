...
export const HomePage = () => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Helmet, null,
            React.createElement("title", null, "D\u00E9pannage & Remorquage Auto Toulouse 24h/24 | Auto Secours 31"),
            React.createElement("meta", { name: "description", content: "Besoin d'un d\u00E9pannage auto \u00E0 Toulouse ? Le Bon Remorquage intervient 24j/7 pour remorquage voiture, moto et utilitaire. Assistance rapide < 30 min. Appelez le 07 68 26 10 50." })),
        React.createElement("div", { className: "relative min-h-[90vh] bg-gray-800" },
            ...
            React.createElement("div", { className: "relative mx-auto flex min-h-[80vh] flex-col items-center justify-center px-4 py-12 text-center" },
                React.createElement("h1", { className: "text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl" },
                    ...
                    React.createElement("span", { className: "text-light-primary dark:text-dark-primary" }, "Auto Secours & Assistance 24/7")),
            ...
            React.createElement("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" },
                React.createElement("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-2" },
                    React.createElement("div", null,
                        ...
                        React.createElement("div", { className: "mt-6 space-y-4" },
                            React.createElement("div", { className: "flex items-start" },
                                ...
                                React.createElement("p", { className: "text-gray-600 dark:text-gray-300" }, "D\u00E9pannage batterie, panne d'essence et r\u00E9paration sur place \u00E0 Toulouse.")),
                            React.createElement("div", { className: "flex items-start" },
                                React.createElement(CheckCircle, { className: "mr-3 h-6 w-6 flex-shrink-0 text-light-primary dark:text-dark-primary" }),
                                React.createElement("p", { className: "text-gray-600 dark:text-gray-300" }, "Remorquage voiture, moto, utilitaire et remorquage parking sous-sol.")),
                            React.createElement("div", { className: "flex items-start" },
                                React.createElement(CheckCircle, { className: "mr-3 h-6 w-6 flex-shrink-0 text-light-primary dark:text-dark-primary" }),
                                React.createElement("p", { className: "text-gray-600 dark:text-gray-300" }, "Assistance technique, levage, treuillage et transport de v\u00E9hicules Europe.")))),
                    React.createElement("div", { className: "mt-8 sm:mt-0" },
                        ...
                        React.createElement("p", { className: "mt-4 text-gray-600 dark:text-gray-300" }, "Votre service d'auto secours 31 intervient rapidement sur Toulouse et sa p\u00E9riph\u00E9rie (Blagnac, Colomiers, Muret, Tournefeuille) 24h/24h. Nous couvrons un rayon de 50 km pour tout d\u00E9pannage / remorquage urgent ou transport longue distance."),
