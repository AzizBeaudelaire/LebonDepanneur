    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "bg-light-background py-12 transition-colors dark:bg-dark-background" },
            React.createElement("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" },
                    ...
                    React.createElement("div", { className: "relative z-10 p-8" },
                        React.createElement("div", { className: "max-w-6xl" },
                            ...
                            React.createElement("div", { className: "mt-8 flex flex-wrap gap-4" },
                                React.createElement("a", { href: "tel:0768261050", className: "inline-flex items-center rounded-full bg-white px-6 py-3 text-light-primary transition-colors hover:bg-gray-100 dark:text-dark-primary shadow-lg" },
                                    React.createElement(Phone, { className: "mr-2 h-5 w-5" }),
                                    React.createElement("span", { className: "font-semibold text-lg" }, "07 68 26 10 50")),
                ...
                React.createElement("div", { className: "mb-16 rounded-xl bg-white p-8 shadow-md dark:bg-dark-card border-l-4 border-light-primary" },
                    React.createElement("h2", { className: "text-2xl font-bold text-gray-900 dark:text-white mb-4" }, "Expert du d\u00E9pannage auto \u00E0 Toulouse (31)"),
                    React.createElement("p", { className: "text-gray-600 dark:text-gray-300 leading-relaxed mb-4 text-lg" },
                        "Le Bon Remorquage est votre partenaire privil\u00E9gi\u00E9 pour tout ",
                        React.createElement("strong", null, "d\u00E9pannage Toulouse"),
                        ". Que vous soyez bloqu\u00E9 sur la rocade toulousaine ou dans un ",
                        React.createElement("strong", null, "parking sous-sol"),
                        ", notre \u00E9quipe intervient 24h/24. Nous sommes \u00E9quip\u00E9s de boosters professionnels pour tout probl\u00E8me de ",
                        React.createElement("strong", null, "batterie"),
                        " et de d\u00E9panneuses adapt\u00E9es aux acc\u00E8s difficiles."),
                    React.createElement("p", { className: "text-gray-600 dark:text-gray-300 leading-relaxed text-lg" }, "Nous couvrons un rayon de 50 km autour de Toulouse, incluant Blagnac, Colomiers et Muret. Notre expertise s'\u00E9tend du simple auto secours au remorquage longue distance en Europe. En cas d'erreur de carburant ou de cl\u00E9s perdues, nos techniciens qualifi\u00E9s vous assurent une assistance rapide et s\u00E9curis\u00E9e.")),
                ...
                React.createElement("section", { className: "rounded-lg bg-light-primary p-8 text-white dark:bg-dark-primary" },
                    React.createElement("div", { className: "text-center" },
                        ...
                        React.createElement("div", { className: "mt-6 flex justify-center space-x-4" },
                            React.createElement("a", { href: "tel:0768261050", className: "inline-flex items-center rounded-full bg-white px-6 py-3 text-light-primary shadow-lg transition-colors hover:bg-gray-100 dark:bg-dark-background dark:text-dark-primary dark:hover:bg-dark-card font-bold" },
                                React.createElement(Phone, { className: "mr-2 h-5 w-5" }),
                                "Appeler maintenant"),
