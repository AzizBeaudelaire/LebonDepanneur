      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 text-center md:text-left text-sm sm:text-base text-gray-300">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-center justify-center md:justify-start">
                ...
                <Link to="/contact" className="text-sm sm:text-base text-gray-300 transition-colors duration-200 hover:text-white">
                  07 70 10 34 29
                </Link>
              </li>
              <li className="flex items-center justify-center md:justify-start">
              ...
              <li className="flex items-center justify-center md:justify-start">
                ...
                <span className="text-sm sm:text-base text-gray-300">Toulouse, France</span>
              </li>
            </ul>
          </div>
          <div className="text-center md:text-left">
            <h3 className="text-base sm:text-lg font-semibold">Liens utiles</h3>
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/mentions-legales" className="text-sm sm:text-base text-gray-300 transition-colors duration-200 hover:text-white">
                  Mentions légales
                </Link>
              </li>
              <li>
                <Link to="/politique-confidentialite" className="text-sm sm:text-base text-gray-300 transition-colors duration-200 hover:text-white">
