    ...
    return (React.createElement("footer", { className: "bg-light-header text-white transition-colors duration-200 dark:bg-dark-header" },
        React.createElement("div", { className: "mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8" },
            React.createElement("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-3" },
                ...
                React.createElement("div", null,
                    React.createElement("h3", { className: "text-lg font-semibold" }, "Contact"),
                ...
                React.createElement("div", null,
                    React.createElement("h3", { className: "text-lg font-semibold" }, "Liens utiles"),
                    React.createElement("ul", { className: "mt-4 space-y-2" },
                        React.createElement("li", null,
                            React.createElement(Link, { to: "/mentions-legales", className: "text-gray-300 transition-colors duration-200 hover:text-white" }, "Mentions l\u00E9gales")),
                        React.createElement("li", null,
                            React.createElement(Link, { to: "/politique-confidentialite", className: "text-gray-300 transition-colors duration-200 hover:text-white" }, "Politique de confidentialit\u00E9"))))),
